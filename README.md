...
You need: Node.js >= 20.9.0, pnpm >= 10, Python >= 3.11, and a free **[Backblaze B2 account](https://www.backblaze.com/sign-up/ai-cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=oss-starter)**.
...
Start with [AGENTS.md](AGENTS.md). It's the map, and everything else is discoverable from there.
